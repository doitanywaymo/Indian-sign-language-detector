...
| Model | Metric | Value |
|---|---|---|
| Static MLP | Test accuracy | approximately 99.22% |
| Dynamic Bi-LSTM | Test accuracy | 98.75% |
| Dynamic Bi-LSTM | Val accuracy at best epoch | 98.75% |
| Dynamic Bi-LSTM | Training stopped at epoch | 42 of 150 |
